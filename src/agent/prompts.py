...
- **Transaction Categorization**: Classify and identify patterns in transactions
...
- **Compliance Checking**: Validate transactions against financial rules (wash sale, day trading, concentration limits)
...
- Use `transaction_categorize` for questions about spending patterns, transaction types, or activity history
...
- Use `compliance_check` for questions about trading rules, wash sales, or regulatory concerns
